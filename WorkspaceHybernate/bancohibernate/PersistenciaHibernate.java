...
// Cliente.hbm.xml: Ponemos el atributo inverse=true en uno de los lados de la relación many_to_many --> <set name="cuentas" table="titular" inverse="true" lazy="true" fetch="select">
